...
class ViewUpdater:
    ...
    async def get_user_channel_activity(
        self,
        user_id: int,
        chat_id: int
    ) -> dict[str, Any] | None:
        ...
        user_records = [
            record for record in self._activity_records
        ...
        activity_stats = {
            ...
            'days_active': (last_message - first_message).days + 1 if first_message != last_message else 1
        }
